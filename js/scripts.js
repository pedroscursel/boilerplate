...
},{"./util.js":2,"jquery":3}],2:[function(require,module,exports){
/*!
...
require('bootstrap/js/dist/modal');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}window.$ = window.jQuery = _jquery2.default; // Coloquei um jQueryzinho aqui pra ajudar galerinha novata :)
// mas se você já é o ninja do VanillaJS pode desconsiderar
$(function () {setTimeout(function () {$('#loading').removeClass('loading');$('#loading').css('display', 'none');}, 1500);}); // importa bootstrap4 inteiro:
// import 'popper.js'
// import 'bootstrap' 
// importa bootstrap4 por modulos:

},{"bootstrap/js/dist/modal":1,"bootstrap/js/dist/util":2,"jquery":3}]},{},[4])
